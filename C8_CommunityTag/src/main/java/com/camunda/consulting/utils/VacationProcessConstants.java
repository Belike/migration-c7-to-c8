...
public class VacationProcessConstants {
  ...
  // Type Names
  public static final String VALIDATE_VACATION_TYPE = "vacationCheck";
  public static final String BOOK_VACATION_TYPE = "vacationBooking";
  public static final String SEND_REJECTION_TYPE = "sendMail";
  public static final String SEND_APPROVAL_TYPE = "sendMail";
